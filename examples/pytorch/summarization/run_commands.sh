...
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ./results/t5-small/2023-03-raf16/pytorch_model.bin  --config_name ./results/t5-small/2023-03-raf16/config.json --tokenizer_name=t5-small --dataset_name ccdv/cnn_dailymail     --dataset_config "3.0.0"   --source_prefix "summarize: "     --output_dir ./results/t5-small/     --per_device_train_batch_size=16     --per_device_eval_batch_size=16     --num_train_epochs=15  --gpus=3
...
#T5-small baseline
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ./results/t5-small/baseline/pytorch_model.bin  --config_name ./results/t5-small/baseline/config.json --tokenizer_name=t5-small --dataset_name ccdv/cnn_dailymail     --dataset_config "3.0.0"   --source_prefix "summarize: "     --output_dir ./results/t5-small/     --per_device_train_batch_size=16     --per_device_eval_batch_size=16    --num_train_epochs=25  --gpus=2 --evaluation_only=True
#Run on other datasets
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ./results/t5-small/2023-03-raf16/pytorch_model.bin  --config_name ./results/t5-small/2023-03-xsum-raf/config.json --tokenizer_name=t5-small --dataset_name xsum      --source_prefix "summarize: "     --output_dir ./results/t5-small/     --per_device_train_batch_size=16     --per_device_eval_batch_size=16     --num_train_epochs=25  --gpus=3 
...
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ainize/bart-base-cnn --dataset_name ccdv/mediasum     --source_prefix "summarize: "     --output_dir ./results/bart/     --per_device_train_batch_size=8     --per_device_eval_batch_size=8    --num_train_epochs=25  --gpus=3 
python examples/pytorch/summarization/run_summarization_no_trainer.py      --model_name_or_path ./results/bart/2023-05-mediasum/pytorch_model.bin  --config_name ./results/bart/2023-05-mediasum/config.json --tokenizer_name ainize/bart-base-cnn --dataset_name ccdv/mediasum     --source_prefix "summarize: "     --output_dir ./results/bart/     --per_device_train_batch_size=8     --per_device_eval_batch_size=8    --num_train_epochs=25  --gpus=2

python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ainize/bart-base-cnn --dataset_name ccdv/arxiv-summarization     --source_prefix "summarize: "     --output_dir ./results/bart/     --per_device_train_batch_size=8    --per_device_eval_batch_size=8    --num_train_epochs=25  --gpus=3 
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ainize/bart-base-cnn --dataset_name xsum     --source_prefix "summarize: "     --output_dir ./results/bart/     --per_device_train_batch_size=8    --per_device_eval_batch_size=8    --num_train_epochs=25  --gpus=1
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path ./results/bart/2023-05-xsum/pytorch_model.bin  --config_name ./results/bart/2023-05-xsum/config.json --tokenizer_name ainize/bart-base-cnn  --dataset_name xsum     --source_prefix "summarize: "     --output_dir ./results/bart/     --per_device_train_batch_size=8    --per_device_eval_batch_size=8    --num_train_epochs=25  --gpus=2

#run with encoder=t5small decoder=gpt2
python examples/pytorch/summarization/run_summarization_no_trainer.py     --model_name_or_path encoder-decoder --dataset_name ccdv/cnn_dailymail  --dataset_config "3.0.0"    --source_prefix "summarization"     --output_dir ./results/encoder-decoder/     --per_device_train_batch_size=8     --per_device_eval_batch_size=8     --num_train_epochs=25  --gpus=2